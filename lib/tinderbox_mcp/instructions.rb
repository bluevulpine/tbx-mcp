...
A reliable write-and-verify sequence:

```
do(document: "MyDoc", note: "/path/to/note", action: "$Text=...")
evaluate(document: "MyDoc", note: "/path/to/note", expression: "$Text")   # confirm in memory
save_document(document: "MyDoc")                                           # written: true
```
